...
// PMP commands for 1st byte
#define PMP_RWR_DATA		0x01
#define PMP_CMD_INFO		0x02	// request prodid and firmware rev.
#define PMP_CMD_FIRMWARE	0x03	// packet containts firmware data
#define PMP_CMD_BOOT_DEVICE	0x04	// reboot into app
#define PMP_CMD_BOOT_LOADER	0x05	// reboot into bootloader
