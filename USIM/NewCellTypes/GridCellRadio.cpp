...
BOOL CGridCellRadio::Draw(CDC* pDC, int nRow, int nCol, CRect rect,  BOOL bEraseBkgnd /*=TRUE*/)
{
    ...
    pDC->DrawFrameControl(GetCheckPlacement(), DFC_BUTTON,
        (m_bChecked) ? DFCS_BUTTONRADIO | DFCS_CHECKED : DFCS_BUTTONRADIO);
...
BOOL CGridCellRadio::SetCheck(BOOL bChecked /*=TRUE*/)
{
...
CRect CGridCellRadio::GetCheckPlacement()
{
