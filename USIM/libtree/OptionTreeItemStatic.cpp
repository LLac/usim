...
UINT COptionTreeItemStatic::GetStaticDataIndex()
{
	return m_DataIndex;
}

void COptionTreeItemStatic::SetStaticDataIndex(UINT iIndex)
{
	// Set variables
	m_DataIndex = iIndex;
}

UINT COptionTreeItemStatic::GetStaticListType()
{
	return m_ListType;
}

void COptionTreeItemStatic::SetStaticListType(UINT iType)
{
	// Set variables
	m_ListType = iType;
}
