...
#define OT_INFOWINDOWLABELHEIGHT		14						// Information window height
#define OT_DEFHEIGHT						21						// Default height of an item
#define OT_SPACE							2						// Default horizontal spacing hb - chenged 5 to 2 pixels
#define OT_EXPANDBOX						11						// Size of the expand box
...
// --- internal messages
#define OT_AUTSIZECOLUM						(WM_USER + 1005)		// autosize column
...
#define OT_NOTIFY_EDITBUTTONCLICK					(OT_NOTIFY_FIRST - 11)	// hb - added edit button click
...
#define OT_TEXTCHANGED						WM_USER + 0x0106		// text changed
// -- Menu Definitions
...
#define OT_EDIT_NUMERICAL					        0x00000200L				// Numerical edit unsigned (int)
// -- Check Box Items
...
// -- Find Item flags
#define OT_FI_LABEL   1
#define OT_FI_ATTRIBUTE 2
#define OT_FI_CONTAINS 4
#define OT_FI_BOTH (OT_FI_LABEL | OT_FI_ATTRIBUTE)
#endif // !OT_TREEDEF
